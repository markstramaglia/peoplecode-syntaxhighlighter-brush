...
;(function()
{
	...
	function Brush()
	{
		...
		*/
		...
		// Current as of PeopleTools 8.54
		var keywords =	
						...
						'Property As Of Protected Import Set End-Set Get End-Get ' +
						...
						'BulkModifyPageFieldOrder BulkUpdateIndexes ' +
						'CallAppEngine CancelPubHeaderXmlDoc CancelPubXmlDoc CancelSubXmlDoc ChangeEmailAddress ' +
						'Char CharType ChDir ChDrive CheckMenuItem ChunkText Clean CleanAttachments ' +
						'ClearKeyList ClearSearchDefault ClearSearchEdit Code Codeb CollectGarbage CommitWork ' +
						'CompareLikeFields CompareStrings CompareTextDiff Component ComponentChanged ' +
						'ConnectorRequest ConnectorRequestURL ContainsCharType ContainsOnlyCharType Continue ' +
						...
						'DateTimeToUserFormat DateTimeValue DateValue Day Days Days360 Days365 DBCSTrim DBPatternMatch ' +
						'DeChunkText Declare Decrypt Degrees DeleteAttachment DeleteEmailAddress DeleteImage DeleteRecord ' +
						'DeleteRow DeleteSQL DeleteSystemPauseTimes DeQueue DetachAttachment DisableMenuItem DiscardRow ' +
						'DoCancel DoModal DoModalComponent DoModalComponentPopup DoModalX DoModalXComponent ' +
						'DoModalPanelGroup DoModalPopup DoSave DoSaveNow EnableMenuItem EncodeSearchCode EncodeURL ' +
						...
						'GenerateActGuideContentUrl GenerateActGuidePortalUrl GenerateActGuideRelativeUrl GenerateComponentContentRelURL ' +
						'GenerateComponentContentURL GenerateComponentPortalRelURL GenerateComponentPortalURL GenerateComponentRelativeURL ' +
						'GenerateExternalPortalURL GenerateExternalRelativeURL GenerateHomepagePortalURL GenerateHomepageRelativeURL ' +
						...
						'GenerateTree GenerateWorklistPortalURL GenerateWorklistRelativeURL GenHTMLMenu GenToken GetABNChartRowSet ' +
						'GetABNInitialNode GetABNNode GetABNRelActnRowSet GetABNReqParameters GetABNTreeEffdt GetABNTreeName ' +
						'GetABNTreeSetid GetABNTreeUserKey GetAddSearchRecName GetAESection GetAnalyticGrid GetAnalyticInstance GetArchPubHeaderXmlDoc ' +
						...
						'GetPubXmlDoc GetRatingBoxChart GetRecord ' +
						'GetReferenceArea ' +
						'GetReferenceLine ' +
						'GetRelField ' +
						'GetRow ' +
		...
		this.regexList = [
			...
			{ regex: /\%this\b/ig,										css: 'keyword' },		// @interface keyword
